    ...
    def display():
        ...
        while True:
            try:
                ...
                if option == 1:
                    hostname, porta, quantidade = https.http(validar.validate_port, validar.validate_quantity)
                    ...
                    ip, porta, quantidade = index.ip_attack(validar.validate_port, validar.validate_quantity)
